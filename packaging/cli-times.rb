...
class CliTimes < Formula
  ...
  # Pinned release — fill these in at publish time:
  # url "https://github.com/howieyoung/cli-times/archive/refs/tags/v0.1.0.tar.gz"
  # sha256 "<fill-in: shasum -a 256 of the v0.1.0 tarball>"
  # version "0.1.0"
  ...
  def install
    ...
    render_ldflags = base + ["-X main.version=#{version rescue "0.1.0-head"}"]
    system "go", "build",
